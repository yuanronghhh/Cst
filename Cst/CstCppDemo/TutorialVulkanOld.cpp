...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile(PROJECT_DIR"/shader/22_shader_ubo_vert.spv");
        auto fragShaderCode = readFile(PROJECT_DIR"/shader/22_shader_ubo_frag.spv");
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        UniformBufferObject ubo = { 1.0f, 2.0f, 1.0f };
