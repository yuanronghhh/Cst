...
static void cst_widget_relayout_i(CstModule *v_module, CstNode *v_parent, CstNode *v_node, FRContext *cr) {
  CST_NODE_CLASS(cst_widget_parent_class)->relayout(v_module, v_parent, v_node, cr);
}
...
static void cst_widget_repaint_i(CstModule *v_module, CstNode *v_parent, CstNode *v_node, FRContext *cr) {
  CST_NODE_CLASS(cst_widget_parent_class)->repaint(v_module, v_parent, v_node, cr);
}
