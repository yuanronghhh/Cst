...
typedef enum _FR_EVENT_ENUM {
  ...
  FR_EVENT_T_WINDOW_CURSOR_LEAVE,
  FR_EVENT_T_WINDOW_CURSOR_ENTER,
  FR_EVENT_T_WINDOW_CLOSE,
  FR_EVENT_T_WINDOW_MAXIMIZE,
  FR_EVENT_T_WINDOW_MINISIZE,
...
typedef struct _FrTaskContext FrTaskContext;
typedef struct _FrTask FrTask;
typedef struct _FrTaskClass FrTaskClass;
