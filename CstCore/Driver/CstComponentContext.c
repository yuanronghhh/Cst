...
/* builder */
SysBool cst_component_context_parse_base(CstComponentContext *self,
    const SysChar *base) {
...
void cst_component_context_set_v_parent(CstComponentContext *self,
...
CstValueMap *cst_component_context_get_value_map(CstComponentContext *self,
    const SysChar *key) {
  sys_return_val_if_fail(self != NULL, NULL);
...
void cst_component_context_set_value_map(CstComponentContext *self,
    CstValueMap *map) {
  sys_return_if_fail(self != NULL);
...
void cst_component_context_set_css_env(CstComponentContext *self,
    FrEnv * css_env) {
  sys_return_if_fail(self != NULL);
...
SysBool cst_component_context_remove_css(CstComponentContext* self,
    CstCssGroup *g) {
  sys_return_val_if_fail(self != NULL, false);
...
void cst_component_context_set_v_module(CstComponentContext *self,
    CstModule * v_module) {
  sys_return_if_fail(self != NULL);
...
void cst_component_context_set_v_pcomponent(CstComponentContext *self,
