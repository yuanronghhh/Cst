...
#define CST_RENDER_NODE_RCTX(o) cst_render_node_get_render_context(o)

typedef struct _CstRenderNodeContext CstRenderNodeContext;
...
struct _CstRenderNode {
  ...
  /* Context for layout algorithm: CstFlexContext */
  CstRenderContext *render_context;
