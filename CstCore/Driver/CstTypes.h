...
typedef enum _CST_DIRECTION_ENUM {
  CST_DIRECTION_ROW,
  CST_DIRECTION_ROW_REVERSE,
  CST_DIRECTION_COLUMN,
  CST_DIRECTION_COLUMN_REVERSE
} CST_DIRECTION_ENUM;
...
typedef enum _CST_NODE_LAYER_ENUM {
  CST_NODE_LAYER_BOX = 1,
  CST_NODE_LAYER_ABS = 2,
  CST_NODE_LAYER_STATIC = 3,
} CST_NODE_LAYER_ENUM;
...
typedef enum _FLEX_JUSTIFY_ENUM {
  FLEX_JUSTIFY_START,
  FLEX_JUSTIFY_END,
  FLEX_JUSTIFY_CENTER,
