...
struct _CstAlgorithmClass {
  ...
  void (*measure) (CstAlgorithm *self, CstRenderNode * rnode, CstRenderContext* ctx);
  void (*layout) (CstAlgorithm *self, CstRenderNode* rnode, CstRenderContext* ctx);
};
...
SYS_API CstAlgorithm* cst_algorithm_get_by_type(SysType tp);
SYS_API CstAlgorithm* cst_algorithm_new_I(void);
SYS_API void cst_algorithm_layout(CstAlgorithm *self, CstRenderNode * rnode, CstRenderContext* ctx);
SYS_API void cst_algorithm_measure(CstAlgorithm *self, CstRenderNode * rnode, CstRenderContext* ctx);
