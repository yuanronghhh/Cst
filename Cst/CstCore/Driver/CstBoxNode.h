...
typedef SysBool (*CstBoxNodeFunc) (CstBoxNode *lnode, SysPointer user_data);
...
void cst_box_node_handle_r(CstBoxNode *self, CstBoxNodeFunc func, SysPointer user_data);
